...
def WV_Function(pssh, lic_url, cert_b64=None):
    ...
    json_data["streaming-request"]["streaming-keys"][0]["challenge"] = b64encode(raw_request).decode("utf-8")
    widevine_license = requests.post(lic_url, headers=headers.headers, json=json_data)
    license_b64 = widevine_license.json()["streaming-response"]["streaming-keys"][0]["license"]
